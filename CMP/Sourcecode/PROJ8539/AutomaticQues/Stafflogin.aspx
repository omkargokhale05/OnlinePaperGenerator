...
<body>
    ...
    <div class="login"  style="border: 1px solid black;height: 900px;width: 1339px;margin: 90px 16px 1px 73px;background-color:#d6e4f5">
    <div class="lcontent" style="border: 1px solid black;width: 406px;height: 430px;margin: 252px 1px 1px 463px;background-color:#cbcecf;     ">
    
        <asp:Image ID="Image1" runat="server"  
            style="position:absolute; top: 337px; left: 534px; height: 75px; width: 414px;" 
            ImageUrl="~/img/stflogin.jpg"/>
    
        <asp:TextBox ID="TextBox1" runat="server"  placeholder="Staff ID"
            
            style="position:absolute; top: 444px; left: 614px; height: 34px; width: 238px;" ></asp:TextBox>
    
        <asp:TextBox ID="TextBox2" runat="server" placeholder="Staff username"
            
            style="position:absolute; top: 516px; left: 616px; height: 32px; width: 236px; bottom: 227px;"     ></asp:TextBox>
    
        <asp:TextBox ID="TextBox3" runat="server" placeholder="Staff password"
            
            style="position:absolute; top: 591px; left: 614px; height: 32px; width: 234px;" 
            TextMode="Password"></asp:TextBox>
    
        <asp:Button ID="Button1" runat="server"  
            style="position:absolute; top: 656px; left: 637px; height: 52px; width: 181px;"  
            Text="LOGIN" BackColor="#0033CC" Font-Names="cursive" Font-Size="20px" 
            ForeColor="White" onclick="Button1_Click" />
    
        <asp:Label ID="Label1" runat="server" Text="<a href='Staffreg.aspx'>Create Newaccount Click here !!</a>" 
            style="position:absolute; top: 728px; left: 603px; width: 293px;" 
            Font-Names="cursive" Font-Size="18px" ForeColor="Maroon"      ></asp:Label>

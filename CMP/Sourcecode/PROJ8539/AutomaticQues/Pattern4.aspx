<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pattern4.aspx.cs" Inherits="Pattern4" %>
...
<body>
  ...
  <div class="Content"  style="border: 1px solid black;height: 2973px;width: 1279px;margin: 1px 1px 1px 118px;background-color:#fff2e2;">
  
  <div class="question" style="border: 1px solid black;width: 1100px;height: 2171px;margin: 754px 1px 1px 86px; background-color:#ebf8f9; ">
   ...
   <asp:Label ID="Label5" runat="server" Text="ENTER 2Marks  QUESTIONS" 
    ...
    <asp:TextBox ID="TextBox7" runat="server" 
          ...
          style="position:absolute; top: 1165px; left: 447px; height: 41px; width: 514px; right: 144px;" 
          ...
          style="position:absolute; top: 1233px; left: 448px; height: 41px; width: 514px; right: 143px;" 
          ...
          style="position:absolute; top: 1662px; left: 438px; height: 41px; width: 514px; right: 153px;" 
          ...
          style="position:absolute; top: 1849px; left: 440px; height: 41px; width: 514px; " 
          AutoPostBack="True" ontextchanged="TextBox17_TextChanged"   ></asp:TextBox>


           <asp:TextBox ID="TextBox18" runat="server" 
          
          style="position:absolute; top: 1962px; left: 440px; height: 41px; width: 514px;" 
          AutoPostBack="True" ontextchanged="TextBox18_TextChanged"   ></asp:TextBox>
         
           <asp:TextBox ID="TextBox19" runat="server" 
          
          style="position:absolute; top: 2097px; left: 444px; height: 41px; width: 514px; right: 147px;" 
   ...
   <asp:Label ID="Label15" runat="server" Text="Q8" 
          ...
          style="position:absolute; top: 2230px; left: 368px; height: 36px;" Font-Names="cursive" 
          Font-Size="22px"    ></asp:Label>

              <asp:Label ID="Label44" runat="server" Text="Q17" 
          style="position:absolute; top: 2351px; left: 373px; height: 36px;" Font-Names="cursive" 
          Font-Size="22px"    ></asp:Label>

            <asp:Label ID="Label45" runat="server" Text="Q19" 
          
          style="position:absolute; top: 2572px; left: 366px; height: 36px; bottom: 275px;" Font-Names="cursive" 
          Font-Size="22px"    ></asp:Label>


           <asp:Label ID="Label47" runat="server" Text="Q20" 
          style="position:absolute; top: 2685px; left: 364px; height: 36px;" Font-Names="cursive" 
          Font-Size="22px"    ></asp:Label>

              <asp:Label ID="Label46" runat="server" Text="Q18" 
          style="position:absolute; top: 2469px; left: 366px; height: 36px;" Font-Names="cursive" 
          Font-Size="22px"    ></asp:Label>
          ...
          style="position:absolute; top: 2099px; left: 369px; height: 36px; bottom: 349px;" Font-Names="cursive" 
          Font-Size="22px"    ></asp:Label>
          ...
          style="position:absolute; top: 2628px; left: 678px;" Font-Names="Algerian" 
          Font-Size="22px" ForeColor="Blue"    ></asp:Label>

             <asp:Label ID="Label25" runat="server" Text="OR" 
          style="position:absolute; top: 2413px; left: 679px; bottom: 340px;" Font-Names="Algerian" 
          Font-Size="22px" ForeColor="Blue"    ></asp:Label>

                <asp:Label ID="Label24" runat="server" Text="OR" 
          style="position:absolute; top: 2172px; left: 670px;" Font-Names="Algerian" 
          Font-Size="22px" ForeColor="Blue"    ></asp:Label>
      ...
      <asp:Label ID="Label29" runat="server" Text="Label" 
          ...
          style="position:absolute; top: 2100px; left: 979px;" Font-Names="cursive" 
          Font-Size="18px" ForeColor="#CC0000"></asp:Label>


           <asp:Label ID="Label49" runat="server" Text="Label" 
          style="position:absolute; top: 2233px; left: 980px;" Font-Names="cursive" 
          Font-Size="18px" ForeColor="#CC0000"></asp:Label>

           <asp:Label ID="Label50" runat="server" Text="Label" 
          style="position:absolute; top: 2355px; left: 983px;" Font-Names="cursive" 
          Font-Size="18px" ForeColor="#CC0000"></asp:Label>


           <asp:Label ID="Label51" runat="server" Text="Label" 
          style="position:absolute; top: 2469px; left: 990px;" Font-Names="cursive" 
          Font-Size="18px" ForeColor="#CC0000"></asp:Label>

           <asp:Label ID="Label52" runat="server" Text="Label" 
          style="position:absolute; top: 2575px; left: 985px;" Font-Names="cursive" 
          Font-Size="18px" ForeColor="#CC0000"></asp:Label>


            <asp:Label ID="Label53" runat="server" Text="Label" 
          style="position:absolute; top: 2688px; left: 991px;" Font-Names="cursive" 
          Font-Size="18px" ForeColor="#CC0000"></asp:Label>
      ...
      <asp:GridView ID="GridView1" runat="server" 
          ...
          CellPadding="3" GridLines="Vertical" AutoGenerateSelectButton="True" onselectedindexchanged="GridView1_SelectedIndexChanged" 
      ...
      <asp:Button ID="Button1" runat="server" Text="Questions Entered" 
          style="position:absolute; top: 2847px; left: 684px; height: 48px; width: 219px;" 
          BackColor="Blue" Font-Names="cursive" Font-Size="20px" ForeColor="White" onclick="Button1_Click1" 
            />
  
  
              <asp:TextBox ID="TextBox20" runat="server" 
          
          style="position:absolute; top: 2229px; left: 445px; height: 41px; width: 514px;" 

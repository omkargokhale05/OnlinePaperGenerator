                ...
                <div class="row">
                    ...
                    <div style="text-align:left;font-size :20px;">             
                       <table class="a">
                        ...
                        <h4><asp:Label ID="Label11" runat="server">16 Marks</asp:Label></h4>
                        <br />
                    <div style="text-align:left;font-size :20px;"> 
                       ...
                       <tr>
                           ...
                           <td>
                            ...
                            <tr>
                                <td class="b">
                                    <asp:Label ID="n17" runat="server">17</asp:Label>
                                </td>
                                <td class="b">
                            ...
                            <tr>
                                ...
                                <td class="b">
                                    <h5><asp:Label ID="Label22" runat="server">OR</asp:Label></h5>
                                </td>
                                <td class="b">
                            ...
                            <tr>
                                <td class="b">
                                    <asp:Label ID="n18" runat="server">18</asp:Label>
                                </td>
                                <td class="b">
                            ...
                            <tr>
                                <td class="b">
                                    <asp:Label ID="n19" runat="server">19</asp:Label>
                                </td>
                                <td class="b">
                            ...
                            <tr>
                                ...
                                <td class="b">
                                    <h5><asp:Label ID="Label25" runat="server">OR</asp:Label></h5>
                                </td>
                                <td class="b">
                            ...
                            <tr>
                                <td class="b">
                                    <asp:Label ID="n20" runat="server">20</asp:Label>
                                </td>
                                <td class="b">

...
<body>
  ...
  <div class="Content"  style="border: 1px solid black;height: 2578px;width: 1279px;margin: 1px 1px 1px 118px;background-color:#efe6d8;">
  
  <div class="question" style="border: 1px solid black;width: 1100px;height: 1718px;margin: 754px 1px 1px 86px; background-color:#ccc; ">
   ...
   <asp:Label ID="Label5" runat="server" Text="ENTER 2Marks  QUESTIONS" 
          ...
          Font-Size="20px" ForeColor="#660033"    ></asp:Label>
            ...
            <asp:Label ID="Label18" runat="server" Text="ENTER 10Marks  QUESTIONS" 
   ...
   <asp:Label ID="Label15" runat="server" Text="Q8" 
          ...
          Font-Size="22px"    ></asp:Label>
             ...
             <asp:Label ID="Label24" runat="server" Text="Q15" 
          style="position:absolute; top: 2095px; left: 370px; height: 33px;" Font-Names="cursive" 
          Font-Size="22px"    ></asp:Label>

           <asp:Label ID="Label25" runat="server" Text="Q16" 
   ...
   <asp:Label ID="Label4" runat="server" Text="Staff ID" 
      ...
      <asp:Button ID="Button1" runat="server" Text="Question Update"  
          style="position:absolute; top: 2337px; left: 687px; height: 44px; width: 181px;" 

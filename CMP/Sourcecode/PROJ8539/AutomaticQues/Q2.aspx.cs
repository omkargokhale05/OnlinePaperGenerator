...
public partial class Q2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        l3.Text = a;
        conn.Open();
        string sql = "select count(*) from p2_dist2";
        SqlCommand cmd = new SqlCommand(sql, conn);
        int cnt = Convert.ToInt32(cmd.ExecuteScalar());

        string sql4 = "select count(*) from p2_dist12";
        ...
        for (int i = 0; i < randomList.Count; i++)
        {
            ...
            string sql1 = "select question,type from p2_dist2 where id='" + r + "'";
        ...
        for (int j = 0; j <randomList1.Count; j++)
        {
            ...
            string sql5 = "select question,type from p2_dist12 where id='" + s + "'";
    ...
    protected void b1_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Pattern2.pdf");

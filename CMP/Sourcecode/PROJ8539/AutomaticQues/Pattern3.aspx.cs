...
public partial class Pattern3 : System.Web.UI.Page
{
     ...
     protected void TextBox5_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q1','" + TextBox5.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void TextBox6_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q2','" + TextBox6.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox7_TextChanged1(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q3','" + TextBox7.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox8_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q4','" + TextBox8.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox9_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q5','" + TextBox9.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox10_TextChanged1(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q6','" + TextBox10.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox11_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q7','" + TextBox11.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox12_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q8','" + TextBox12.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox13_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q9','" + TextBox13.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox14_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q10','" + TextBox14.Text + "','2','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox15_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q11','" + TextBox15.Text + "','16','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox16_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q12','" + TextBox16.Text + "','16','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox17_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q13','" + TextBox17.Text + "','16','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();
    }
    protected void TextBox18_TextChanged(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("insert into StaffQuestions3(QNo,Questions,Mark_Allocation,Staff_Id,Staff_Name,Subject_Code,Question_Type,Pattern_type) values('Q14','" + TextBox18.Text + "','16','" + TextBox2.Text + "','" + TextBox1.Text + "','" + TextBox3.Text + "','" + qtype + "','"+pattern+"')", con);
        cmd.ExecuteNonQuery();
        con.Close();

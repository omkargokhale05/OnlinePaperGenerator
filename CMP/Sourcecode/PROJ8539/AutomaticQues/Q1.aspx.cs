...
public partial class Q1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "select count(*) from p1_dist2";
        SqlCommand cmd = new SqlCommand(sql,conn);
        int cnt = Convert.ToInt32(cmd.ExecuteScalar());

        string sql4 = "select count(*) from p1_dist10";
        ...
        for (int i = 0; i < randomList.Count; i++)
        {
            ...
            string sql1 = "select question,type from p1_dist2 where id='"+r+"'";
       ...
       // Label12.Text = cnt1.ToString();
        for (int j = 0; j < randomList1.Count; j++)
        {
            ...
            string sql5 = "select question,type from p1_dist10 where id='" + s + "'";

...
<body> 
    ...
    <div class="login"  style="border: 1px solid black;height: 900px;width: 1339px;margin: 90px 16px 1px 73px;background-color:#c6f9f4;">
    <div class="lcontent" style="border: 1px solid black;width: 406px;height: 430px;margin: 252px 1px 1px 463px;background-color:#cbcecf;     ">
        ...
        <asp:Image ID="Image1" runat="server"  
            ...
            ImageUrl="~/img/AdminLogin.png"/>
    
        <asp:TextBox ID="TextBox1" runat="server"  placeholder="Admin username"
            
            
            style="position:absolute; top: 471px; left: 615px; height: 34px; width: 238px;" ></asp:TextBox>
    
        <asp:TextBox ID="TextBox2" runat="server" placeholder="Admin Password"
            
            
            
            style="position:absolute; top: 549px; left: 617px; height: 32px; width: 236px; bottom: 206px;" 
            TextMode="Password"     ></asp:TextBox>
    
        <asp:Button ID="Button1" runat="server"  
            style="position:absolute; top: 630px; left: 641px; height: 52px; width: 181px;"  
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 col-md-pull-9 animated wow fadeInUp" data-wow-delay="0.8s">
							...
							<p class="fh5co-copyright"><small>&copy; 2018. All Rights Reserved. <br>	by <a href="#" target="_blank">aspxtemplates.com</a> Images: <a href="#" target="_blank">Pexels</a></small></p>
